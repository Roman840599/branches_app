    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facade_image', models.ImageField(blank=True, null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position_title', models.TextField(verbose_name='Position')),
                ('branch_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employees', to='mainapp.branch')),
            ],
            options={
                'ordering': ('last_name',),
            },
